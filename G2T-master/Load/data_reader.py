...
class PaviaURaw(DataReader):
    def __init__(self):
        ...
        raw_data_package = sio.loadmat(r"E:\SCZ\WFCG-master\Datasets\paviaU\PaviaU.mat")
        self.data_cube = raw_data_package["data"].astype(np.float32)
        truth = sio.loadmat(r"E:\SCZ\WFCG-master\Datasets\paviaU\PaviaU_gt.mat")
...
class IndianRaw(DataReader):
    def __init__(self):
        ...
        raw_data_package = sio.loadmat(r"H:\SCZ\WFCG-master\Datasets\IndianPine\Indian_pines_corrected.mat")
        self.data_cube = raw_data_package["data"].astype(np.float32)
        truth = sio.loadmat(r"H:\SCZ\WFCG-master\Datasets\IndianPine\Indian_pines_gt.mat")
        self.g_truth = truth["groundT"].astype(np.float32)
